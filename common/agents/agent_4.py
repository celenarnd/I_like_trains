...
class Agent(BaseAgent):
    ...
    def get_move(self) -> Move:
        ...
        if adjacent_passenger and not train.get("wagons", []):
        ...
        if train.get("wagons", []):
            ...
            # We have no wagons, target the optimal passenger
    ...
    def needs_new_path(self, current_pos: Tuple[int, int]) -> bool:
        ...
        if not has_wagons and self.target_type == "passenger":
